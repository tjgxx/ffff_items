class FFFF_CraftGlowMushroomsBag extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Make Glow Mushroom Bag";
		...
		InsertIngredient(0,"FFFF_Glow_Mushroom_Green");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1, "FFFF_Glow_Mushroom_Green");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("FFFF_Glow_Mushrooms_Bag");//add results here
...
class FFFF_CraftGlowMushroomsBrick extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Make Glow Mushroom Brick ";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		...
		InsertIngredient(0,"FFFF_Glow_Mushrooms_Bag");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("FFFF_Glow_Mushrooms_Brick");//add results here
...
class FFFF_CraftGlowMushroomsCigarettePackEmpty extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Pack Glow Mushroom joint into Cigarette Pack";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		...
		InsertIngredient(0,"FFFF_Glow_Mushrooms_Joint");//you can insert multiple ingredients this way
		m_IngredientAddHealth[0] = 0;// 0 = do nothing
		m_IngredientSetHealth[0] = -1; // -1 = do nothing
		...
		//result1
		AddResult("FFFF_Glow_Mushrooms_Cigarette_Pack");//add results here
...
class FFFF_CraftGlowMushroomsCigarettePack extends RecipeBase
{	
	override void Init()
	{
		...
		InsertIngredient(0,"FFFF_Glow_Mushrooms_Joint");
		m_IngredientAddHealth[0] = 0;// 0 = do nothing
		m_IngredientSetHealth[0] = -1; // -1 = do nothing
		m_IngredientAddQuantity[0] = 0;// 0 = do nothing
		m_IngredientDestroy[0] = true;//true = destroy, false = do nothing
		...
		InsertIngredient(1, "FFFF_Glow_Mushrooms_Cigarette_Pack");
		m_IngredientAddHealth[1] = 0;// 0 = do nothing
		m_IngredientSetHealth[1] = -1; // -1 = do nothing
		m_IngredientAddQuantity[1] = 0;// 0 = do nothing
		m_IngredientDestroy[1] = false;// false = do nothing
...
class FFFF_CraftCigsGlowMushrooms extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Roll a Joint out of finest Glow Mushrooms";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 0.5;//animation length in relative time units
		m_Specialty = -0.01;// value > 0 for roughness, value < 0 for precision
		...
		//result1
		AddResult("FFFF_Glow_Mushrooms_Joint");//add results here
...
class FFFF_DeCraftGlowMushroomsBag extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Cut Open Glow Mushroom Bag";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 0.5;//animation length in relative time units
		m_Specialty = -0.01;// value > 0 for roughness, value < 0 for precision
		...
		//result1
		AddResult("FFFF_Glow_Mushroom_Green");//add results here
...
class FFFF_DeCraftGlowMushroomsBrick extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Cut Open Glow Mushrooms Brick ";
		m_IsInstaRecipe = false;//should this recipe be performed instantly without animation
		m_AnimationLength = 2;//animation length in relative time units
		m_Specialty = -0.01;// value > 0 for roughness, value < 0 for precision
		...
		InsertIngredient(0,"FFFF_Glow_Mushrooms_Brick");//you can insert multiple ingredients this way
